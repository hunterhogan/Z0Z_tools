...
def merge_sorted(*seqs: Iterable[TSupportsRichComparison], key: Callable[[TSupportsRichComparison], TSupportsRichComparison] | None = None) -> Iterator[TSupportsRichComparison]:
