...
@pytest.mark.parametrize(
	...
	[
		...
		pytest.param(2, {'alpha': 11, 'beta': 22, 'gamma': 33, 'delta': 44}.items(), (('gamma', 33), ('delta', 44)), id='itemsview_n2'),
		pytest.param(
			10,
		...
		pytest.param(
			10, {'alpha': 11, 'beta': 22, 'gamma': 33, 'delta': 44}.keys(), ('alpha', 'beta', 'gamma', 'delta'), id='keysview_n_gt_len'
		),
...
@pytest.mark.parametrize(
	...
	[
		...
		pytest.param(
			0, {'alpha': 11, 'beta': 22, 'gamma': 33, 'delta': 44}, (), ('alpha', 'beta', 'gamma', 'delta'), id='mapping_n0_issue626'
		),
		pytest.param(
			0,
			{'alpha': 11, 'beta': 22, 'gamma': 33, 'delta': 44}.items(),
		...
		pytest.param(0, {'alpha': 11, 'beta': 22, 'gamma': 33, 'delta': 44}.values(), (), (11, 22, 33, 44), id='valuesview_n0_issue626'),
	],
)
...
def test_join() -> None:
	...
	expected: set[tuple[int, str, str, int]] = {
		(1, 'one', 'apple', 1),
		(1, 'one', 'orange', 1),
		(2, 'two', 'banana', 2),
		(2, 'two', 'coconut', 2),
